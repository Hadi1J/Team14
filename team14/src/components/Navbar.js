...
const Navbar = ({ cartCount }) => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-white" style={{ paddingLeft: '100px', paddingRight: '100px' }}>
            <div className="container-fluid">
                <a className="navbar-brand" href="#" style={{ marginRight: '15px' }}>
                    <i className="bi-megaphone" style={{ color: 'white', backgroundColor: '#0085ff', borderRadius: '0.25rem', padding: '6px 8px' }}></i>
                </a>
                ...
                <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="navbarNav">
                    ...
                    <div className="d-flex align-items-center ms-auto">
                        ...
                        <button className="btn mx-2" style={{ backgroundColor: '#e9ecef', borderRadius: '0.25rem', padding: '6px 8px' }}>
                            <i className="bi-chat" style={{ fontSize: '1.5rem' }}></i>
                        </button>
                        <button className="btn mx-2" style={{ backgroundColor: '#e9ecef', borderRadius: '0.25rem', padding: '6px 8px' }}>
                            <i className="bi-gear" style={{ fontSize: '1.5rem' }}></i>
                        </button>
                        <button className="btn mx-2 position-relative" style={{ backgroundColor: '#e9ecef', borderRadius: '0.25rem', padding: '6px 8px' }}>
                            <i className="bi-bell" style={{ fontSize: '1.5rem' }}></i>
                            <span className="position-absolute" style={{ top: '-5px', right: '-5px', width: '10px', height: '10px', backgroundColor: 'red', borderRadius: '50%', border: '2px solid white' }}></span>
                        </button>
                        <button className="btn" style={{ backgroundColor: '#e9ecef', borderRadius: '0.25rem', padding: '6px 8px' }}>
                            <i className="bi-person-square" style={{ fontSize: '1.5rem' }}></i>
                        </button>
                    </div>
                </div>
            </div>
